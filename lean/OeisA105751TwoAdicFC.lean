...
/-!
# OEIS A105751: proof of the Formal Conjectures 2-adic target

This file proves the registered theorem directly. It does not invoke the imported open declaration.
...
/-- The exact current Formal Conjectures target, proved without using `OeisA105751.conjecture`. -/
theorem oeisA105751_conjecture :
    Tendsto
      (fun n : ℕ ↦
        (4 : ℚ) * (padicValInt 2 (OeisA105751.a n) : ℚ) / (n : ℚ))
      atTop (nhds 1) := by
  simpa only [sequenceA, OeisA105751.a] using sequenceA_conjecture

#print axioms oeisA105751_conjecture
